...
<body style="background-image: linear-gradient(to right,rgb(66, 5, 60), rgb(36, 30, 35));">
 ...
 ; border-style: none;" aria-controls="offcanvasExample">
    ...
    <div class="offcanvas offcanvas-start" tabindex="-1" id="offcanvasExample" aria-labelledby="offcanvasExampleLabel" style="background-image: linear-gradient(to right,rgb(66, 5, 60), rgb(36, 30, 35));   color: white;">
        ...
        <div class="offcanvas-body">
            <div class="dropdown mt-3">
                           ...
                           <a href="home.html" style="text-decoration: none; color: white;font-family: Poppins;font-size: 20px; margin-bottom: 20px;">
    ...
    <div class="editmedia container">
        ...
        <a href="keranjang.php" style="text-decoration:none; color: rgba(255, 255, 255, 0.975);">
            <div class="media-element">
                <img src="https://downloadr2.apkmirror.com/wp-content/uploads/2023/03/31/641a7b9438b07.png" alt="">
        ...
        <a href="keranjang.php" style="text-decoration:none; color: rgba(255, 255, 255, 0.975);">
            <div class="media-element">
                <img src="https://fin.co.id/upload/32114dde8ff553507ff4f8896280a5ba.jpg" alt="">
        ...
        <a href="keranjang.php" style="text-decoration:none; color: rgba(255, 255, 255, 0.975);">
            <div class="media-element">
                <img src="https://play-lh.googleusercontent.com/fRFOz7hD7C0r4b6Dity3muFFPm90gXPiVKAHNyJvPHA6Y__Qdi05lnsbeylGtUylJQ=w240-h480-rw" alt="">
        ...
        <a href="keranjang.php" style="text-decoration:none; color: rgba(255, 255, 255, 0.975);">
            <div class="media-element">
                <img src="https://seeklogo.com/images/V/valorant-logo-FAB2CA0E55-seeklogo.com.png" alt="">
        ...
        <a href="keranjang.php" style="text-decoration:none; color: rgba(255, 255, 255, 0.975);">
            <div class="media-element">
                <img src="https://play-lh.googleusercontent.com/caDiIvFl-VDvEPlzbHuypmXMTIwAiA8WesvsUIcFoQqokLaYRSYh-Y0LpR4RFhGgytEg=w240-h480-rw" alt="">
    ...
    <div class="editmedia container">
        ...
        <a href="keranjang.php" style="text-decoration:none; color: rgba(255, 255, 255, 0.975);">
            <div class="media-element">
                <img src="https://play-lh.googleusercontent.com/1XA9Ylaaw5GUleSwkSHAl-bBBnpB9LrysN_hfxP9EwCAUrybQuqLbz8EafpdHwHTQw=w240-h480-rw" alt="">
        ...
        <a href="keranjang.php" style="text-decoration:none; color: rgba(255, 255, 255, 0.975);">
            <div class="media-element">
                <img src="https://e1.pxfuel.com/desktop-wallpaper/912/410/desktop-wallpaper-clash-of-clans-app-icon.jpg" alt="">
        ...
        <a href="keranjang.php" style="text-decoration:none; color: rgba(255, 255, 255, 0.975);">
            <div class="media-element">
                <img src="https://upload.wikimedia.org/wikipedia/id/0/07/CODM_logo.png" alt="">
        ...
        <a href="keranjang.php" style="text-decoration:none; color: rgba(255, 255, 255, 0.975);">
            <div class="media-element">
                <img src="https://play-lh.googleusercontent.com/Za8u0ChNK-3mZ3rnLcBirRBTzLYTdqaaAn63Ha9qKZiDp_bF_5u7OGfvWb1dg88WttKw" alt="">
        ...
        <a href="keranjang.php" style="text-decoration:none; color: rgba(255, 255, 255, 0.975);">
            <div class="media-element">
                <img src="https://cdn-1.webcatalog.io/catalog/now-gg-9364-legends-wild-rift/now-gg-9364-legends-wild-rift-icon-filled-256.png?v=1699580967564" alt="">
        ...
        <a href="keranjang.php" style="text-decoration:none; color: rgba(255, 255, 255, 0.975);">
            <div class="media-element">
                <img src="https://avatars.cloudflare.steamstatic.com/2b6f548819d7d1e7d1e15a43068c48290b0257e4_full.jpg" alt="">
