...
<body>
    ...
    <form action="daftar2.php" method="post">
        <div class="mb-3">
            <input style="border-radius: 50px;width: 500px;height: 57px;margin-bottom: 30px; background-color: rgb(121, 121, 154);;border-style: none;" placeholder="Nama Lengkap" type="text" class="form-control" id="nama" name="user">
            <input style="border-radius: 50px;width: 500px;height: 57px;margin-bottom: 30px; background-color: rgb(121, 121, 154);;border-style: none;" placeholder="Email" type="email" class="form-control" id="exampleInputEmail1" name="email">
        ...
        <br>
        <button style="border-radius: 50px;width: 500px;height: 57px;margin-bottom: 30px; background-color: rgb(36, 36, 242) ;color: white; border-style: none;" class="btn " type="submit " name="submitform" >Daftar</button>
        <br>
    </form>
           <span style="margin-left: 170px; margin-bottom: 30px;font-family: sans-serif;">Sudah Punya Akun?</span><br>
    
          <a href="loginPage.php"> <button style="margin-top: 30px; border-radius: 50px;width: 500px;height: 57px;margin-bottom: 30px; background-color: rgb(255, 255, 255) ;color: rgb(0, 0, 0); border-style: none;" class="btn ">Masuk Sekarang</button></a>
