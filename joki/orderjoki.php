...
<?php
            ...
            <?php
                    ...
                    ?>
                        <div class="navbar-nav ml-auto">    
                            ...
                            <a class="btn" href="../daftar/loginPage.php" role="button" style=" font-size:16px;margin-left: 10px; background-color: rgb(36, 36, 242) ; border-style:none; color: black; font-family: Poppins; color:white;border-radius:10px;margin-right: 112px;">Masuk</a>
                        </div>
                    <?php
                    }
                ?>
    ...
    <div class="editgambar container">
            ...
            <img src="https://pbs.twimg.com/media/GVA-d6QbMAAtjDY.jpg:large" style="height: 300px;" class="d-block w-100" alt="...">
...
<center>&copy;Projek IMK May & Sakti & Bagas 2023</center>
    ...
    if (token) {
        ...
        onSuccess: function(result){
            ...
            window.location.href = `https://559e-182-253-126-28.ngrok-free.app/projekimktopup2/updateDatabase/update.php?token=${token}&type=joki`;
